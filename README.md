<h1 align="center">Cloud-storage-management</h1>
<div align="center">
...
## <a name="features">Live Demo</a>
https://cloud-storage-management-mocha.vercel.app/sign-up
Click on the above link and fill up the necessary details.You would receive an otp with the registered email id, 
...
```bash
git clone https://github.com/Saikrishnan0/Cloud-storage-management
